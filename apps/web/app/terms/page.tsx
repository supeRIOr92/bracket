    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="space-y-8 text-gray-600 leading-relaxed">
        ...
        <section>
          ...
          <p>For questions regarding these terms, contact us at <a href="mailto:hello@basebracket.xyz" className="text-blue-600 hover:underline">hello@basebracket.xyz</a>.</p>
        </section>
